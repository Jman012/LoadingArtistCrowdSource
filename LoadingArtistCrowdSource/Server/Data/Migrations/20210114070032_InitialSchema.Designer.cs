...
namespace LoadingArtistCrowdSource.Server.Data.Migrations
{
    ...
    [Migration("20210114070032_InitialSchema")]
            ...
            modelBuilder.Entity("LoadingArtistCrowdSource.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECj1ck3bM0AHKaarzX5DSSLNKUulcJBNwbMtMUT725YzRM3V789Tpk6VA9CjzC4bLg==",
                            PhoneNumber = "",
            ...
            modelBuilder.Entity("LoadingArtistCrowdSource.Server.Models.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImportedDate = new DateTimeOffset(new DateTime(2021, 1, 13, 23, 0, 32, 442, DateTimeKind.Unspecified).AddTicks(5945), new TimeSpan(0, -8, 0, 0, 0)),
